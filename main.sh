...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To IBNU TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}IBNU TUNNELING ® ${NC}${YELLOW}(${NC} ${green} YANG NYOLONG YATIM ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self IBNU TUNNELING ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ibnuganteng37/v1/main/"
...
clear
izinsc="https://raw.githubusercontent.com/Ibnuganteng37/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> IBNU VPN STORE SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/IbnuVpnStore"}]]}' 
...
wget -q https://raw.githubusercontent.com/Ibnuganteng37/v3/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
